...
class Button_Hotels(General):
    ...
    def __init__(self, root, list_p, cname, uname, mail, pname, pprice, title_name, ind):
        ...
        if self.ind == 'del':
            delete = Button(self.root, text="Delete", borderwidth=5, command=self.do_delete, width=17)
            delete.place(x=1320, y=770)
            back = Button(self.root, text="<<", borderwidth=5, command=self.go_to_cart, width=20)
            ...
            back = Button(self.root, text="<<", borderwidth=5, command=lambda: self.deletePart("Description"), width=20)
            back.grid(row=0, column=0, stick='we')
            ...
            buy = Button(self.root, text="BUY", borderwidth=5, command=self.do_buy, width=17)
            buy.place(x=1320, y=770)
            if General.title_name == 'Cities':
                back = Button(self.root, text="<<", borderwidth=5, command=self.go_to_cities, width=20)
                back.grid(row=0, column=0, stick='we')
            else:
