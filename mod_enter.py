...
class Moderator(Login):
    ...
    def __init__(self, root):
        super().__init__(root)
        lab = Label(root, text='Moderator Login', font=("Times New Roman", 16, 'bold'), bg='grey')
        ...
        if flag:
            ...
            if flag1:
                ...
                messagebox.showerror("Wrong Login!",
                                     "You a trying to enter like a moderator.\n Try to enter from user's Login!")
                self.go_to_menu()
    ...
    def forgotPass(self):
        ...
        temp_m.config(bg='grey')
        password.Forgot_Pass(temp_m, 'mod_login')
        self.root.destroy()
